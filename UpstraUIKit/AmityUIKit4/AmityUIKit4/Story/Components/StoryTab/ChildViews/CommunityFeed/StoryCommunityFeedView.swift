...
struct StoryCommunityFeedView: View {
    ...
    private var storyTargetView: some View {
        if let storyTarget = viewModel.communityFeedStoryTarget {
            StoryTargetView(radius: 56.0, componentId: id, storyTarget: storyTarget, storyTargetName: AmityLocalizedStringSet.Social.storyTargetDefaultName.localizedString, hideLockIcon: true, hideRingWhenEmpty: true, cornerImage: {
