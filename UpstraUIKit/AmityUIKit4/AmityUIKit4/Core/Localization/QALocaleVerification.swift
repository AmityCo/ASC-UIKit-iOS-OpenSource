...
public enum QALocaleVerification {
    ...
    static let thaiChatBundle: [String: String] = [
        ...
        "chat_preview_deleted":             "ข้อความนี้ถูกลบแล้ว",
        "chat_option_reply":                "ตอบกลับ",
        "chat_option_copy":                 "คัดลอก",
        "chat_option_delete":               "ลบ",
        "chat_button_report":               "รายงาน",
        "chat_button_un_report":            "ยกเลิกรายงาน",
        "chat_button_ok":                   "ตกลง",
        "chat_load_error":                  "ไม่สามารถโหลดแชทได้",
        "amity_chat_label_banned_from_chat":     "คุณถูกแบนจากแชท",
        ...
        "chat_group_member_count":          "%@ สมาชิก",
    ...
    static let italianChatOverrides: [String: String] = [
        ...
        "chat_preview_deleted":             "Questo messaggio è stato eliminato",
        "chat_option_reply":                "Rispondi",
        "chat_option_copy":                 "Copia",
        "chat_option_delete":               "Elimina",
        "chat_button_report":               "Segnala",
        "chat_button_un_report":            "Annulla segnalazione",
        "chat_button_ok":                   "OK",
        "chat_load_error":                  "Impossibile caricare la chat",
        "amity_chat_label_banned_from_chat":     "Sei stato bannato dalla chat",
        ...
        "chat_group_member_count":          "%@ membri",
