...
private struct URLImageServiceEnvironmentKey: EnvironmentKey {
    static let defaultValue: URLImageService = URLImageService.defaultImageService
}


@available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, *)
private struct URLImageOptionsEnvironmentKey: EnvironmentKey {
    static let defaultValue: URLImageOptions = URLImageOptions.defaultImageOptions
}
