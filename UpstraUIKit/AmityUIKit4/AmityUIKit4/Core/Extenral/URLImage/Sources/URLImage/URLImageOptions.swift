...
public struct URLImageOptions {
    public static let defaultImageOptions = URLImageOptions(loadOptions: [ .loadImmediately ])
    
    public static var amityOptions: URLImageOptions {
        URLImageOptions(loadOptions: [.loadImmediately], urlRequestConfiguration: Download.URLRequestConfiguration(allHTTPHeaderFields: ["Authorization": "Bearer \(AmityUIKitManagerInternal.shared.client.accessToken ?? "")"], cachePolicy: .useProtocolCachePolicy))
    }
