...
final class AmityFileCache {
        ...
        do {
            ...
            for file in directoryContents {
                ...
                do {
                    ...
                    Log.add(event: .error, "Error when deleting file from cache directory")
                }
            }
        } catch {
            Log.add(event: .error, error.localizedDescription)
    ...
    func getCachedDownloadedFile(id: String) -> URL? {
        ...
        do {
            ...
            Log.add(event: .error, "Error while fetching file from destination \(fetchError)")
            return nil
        }
    }
}
