...
// Expanded & Normal
struct PollVoteTextOptionView: View {
    ...
    var body: some View {
        Button(action: {
            ...
            .padding(.vertical, 12)
            .border(radius: 8, borderColor: Color(isSelected ? viewConfig.theme.primaryColor : viewConfig.theme.baseColorShade4 ), borderWidth: isSelected ? 2 : 1)
