//
//  AmityStoryCommentSettingsCommunityViewModel.swift
//  AmityUIKit
//
...
protocol AmityStoryCommentSettingsCommunityViewModelProtocol {
    func getCommunity(_ completion: ((Result<AmityCommunityModel, AmityError>) -> Void)?)
}

final class AmityStoryCommentSettingsCommunityViewModel: AmityStoryCommentSettingsCommunityViewModelProtocol {
